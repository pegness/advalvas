...
public function blockForm($form, FormStateInterface $form_state) {
	...
	$form['tweets_username'] = array(
		...
		'#description' => $this->t(''),
		'#default_value' => isset($this->configuration['tweets_username']) ? $this->configuration['tweets_username'] : 'advalvas_vu',
	);
...
public function build() {
  ...
  $getfield = '?list_id=76096108&owner_screen_name=' . $this->configuration['tweets_username'] . '&count=' . $this->configuration['tweets_limit'];
	$requestMethod = 'GET';
